chatApp.views.chat.ChatView = Backbone.View.extend({
  ...
  fetchRooms: function (rooms) {
    ...
    function showRoom(room) {
      ...
      room.clients.forEach(showClient);
    }
  ...
  newUser: function (message) {
    var messageView = new chatApp.views.chat.message.NewUserMessageView({
      model: message
    });
  ...
  userLeft: function (message) {
    var messageView = new chatApp.views.chat.message.UserLeftMessageView({
      model: message
    });
    this.showMessage(messageView);
  },
  ...
  send: function (e) {
    ...
    var messageView = new chatApp.views.chat.message.MyMessageView({
      model: message
    });
    this.showMessage(messageView);
